...
# Purpose....: Datei zum setzten der Instanz spezifischen Umgebung. Grundsaetzlich
...
# auskommentiert. Wichtig ist dabei, dass die entsprechende Umgebung gesetzt ist.
# Wird OUD Base nicht verwendet, sind die folgenden Variablen explizit zu setzten.
# ---------------------------------------------------------------------------
