...
# Purpose....: Script für die Ausführung der Instanz Batch Konfigurationsdatei
# Notes......: Das Script laedt das LDIF file 02_configure_instance.ldif und
#              fuehrt die dsconfig Kommandos aus 02_configure_instance.config
